...
public class Attack {
    ...
    public void pokemonSelect(int nowAttackPlayer,int playerbeAttack,ArrayList<Pokemon> playerattack,ArrayList<Pokemon> playerbeingattack){
        ...
        if(playerbeingattack.get(player.get(playerbeAttack).nowPokemon).remainHealth==0){
            player.get(playerbeAttack).InAttackforPitemleftovers();
            ...
            playerbeingattack.get(player.get(playerbeAttack).nowPokemon).leftoversInAttack();
        }
    ...
    public void AttackPrintInfo(){
        ...
        System.out.println((player.get(0).nowPokemon+1)+"  "+player1.get(player.get(0).nowPokemon).property + "    " + player1.get(player.get(0).nowPokemon).level + "      " + player1.get(player.get(0).nowPokemon).remainHealth
                + "    (" + player1.get(player.get(0).nowPokemon).skill1 + "/5)    (" + player1.get(player.get(0).nowPokemon).skill2+"/"+player1.get(player.get(0).nowPokemon).Attack2limit+")         ("+player1.get(player.get(0).nowPokemon).roundexperience+"/"+player1.get(player.get(0).nowPokemon).totalexperience+")");
		...
		System.out.println((player.get(1).nowPokemon+1)+"  "+player2.get(player.get(1).nowPokemon).property + "    " + player2.get(player.get(1).nowPokemon).level + "      " + player2.get(player.get(1).nowPokemon).remainHealth
                + "    (" + player2.get(player.get(1).nowPokemon).skill1 + "/5)    (" + player2.get(player.get(1).nowPokemon).skill2+"/"+player2.get(player.get(1).nowPokemon).Attack2limit+")         ("+player2.get(player.get(1).nowPokemon).roundexperience+"/"+player2.get(player.get(1).nowPokemon).totalexperience+")");
    ...
    public void AfterAttackPrintInfo(String winner,String looser,ArrayList<Pokemon> lose){
		...
		for (int n = 0; n < player1.size(); n++) {
            ...
            player1.get(n).dataRefresh();
            player1.get(n).PitemafterAttack();
			System.out.println((n+1)+"  "+player1.get(n).property + "    " + player1.get(n).level + "      " + player1.get(n).remainHealth
					+ "    (" + player1.get(n).skill1 + "/5)    (" + player1.get(n).skill2+"/"+player1.get(n).Attack2limit+")       ("+player1.get(n).roundexperience+"/"+player1.get(n).totalexperience+")");
        }
		...
		for (int n = 0; n < player2.size(); n++) {
            ...
            player2.get(n).PitemafterAttack();
            System.out.println((n+1)+"  "+player2.get(n).property + "    " + player2.get(n).level + "      " + player2.get(n).remainHealth
					+ "    (" + player2.get(n).skill1 + "/5)    (" + player2.get(n).skill2+"/"+player2.get(n).Attack2limit+")       ("+player2.get(n).roundexperience+"/"+player2.get(n).totalexperience+")");
		}
		System.out.println("----------------------------------------------------------");
        resetroundexperience();
	}
    ...
    public void maxelixir(ArrayList<Pokemon> playernum, int nowAttackPlayer){
        if(player.get(nowAttackPlayer).maxelixir==0){
            System.out.println("技能回復劑(max elixir)已使用完畢");
        }else{
            player.get(nowAttackPlayer).maxelixir--;
            playernum.get(player.get(nowAttackPlayer).nowPokemon).skill1=5;
            playernum.get(player.get(nowAttackPlayer).nowPokemon).skill2=playernum.get(player.get(nowAttackPlayer).nowPokemon).Attack2limit;
            System.out.println("技能攻擊次數已恢復");
            System.out.println("----------------------------------------------------------");
            System.out.println("玩家"+player.get(nowAttackPlayer).playername+"已使用技能回復劑(max elixir)");
            System.out.println("剩餘次數:"+player.get(nowAttackPlayer).maxelixir+"/2)");
        }
